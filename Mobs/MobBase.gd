...
const UpgradeTypes = preload("res://upgrade_types.gd")
	...
	var upgrades = [
		{
			...
			"texture": preload("res://upgrades/speedboost.png")
		},
		{
			"type": UpgradeTypes.UpgradeType.BULLET_SPEED,
			"texture": preload("res://upgrades/bulletspeed.png")
		},
		{
			"type": UpgradeTypes.UpgradeType.DAMAGE,
			"texture": preload("res://upgrades/damage.png")
		}
	]
...
func drop_upgrade(type: int, texture: Texture2D) -> void:
	const UPGRADE = preload("res://speedboost.tscn")
