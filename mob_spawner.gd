...
var mob_scenes = [
	{"scene": preload("res://Mobs/green_slime.tscn"), "min_level": 1},
	{"scene": preload("res://Mobs/gray_slime.tscn"), "min_level": 4},
	{"scene": preload("res://Mobs/pink_slime.tscn"), "min_level": 2}
]
